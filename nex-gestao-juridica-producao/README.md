...
## Versão 3.7 Enterprise ERP Jurídico

Inclui CRM jurídico, Agenda, Equipe, Módulos Jurídicos especializados, Ponto Corporativo com PIN e ajustes, relatórios ampliados e migração Supabase enterprise.

Arquivo de detalhes: `ALTERACOES_V37_ENTERPRISE_ERP_JURIDICO.md`.
