...
export function scopeStateForProfile(state: AppState, profile: AuthProfile | null | undefined): AppState {
  ...
  if (profile.role === "cliente") {
    ...
    const clientId = profile.clientId;
    if (!clientId) return { ...hydrated, clients: [], processes: [], deadlines: [], tasks: [], finances: [], documents: [], messages: [], pricings: [], hearings: [], clientConsents: [], legalModuleRecords: [], ruralProperties: [], feeContracts: [], costEntries: [], documentFolders: [], notifications: [], auditLogs: [] };
