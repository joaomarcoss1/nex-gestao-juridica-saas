...
export function EquipePage(props: FeaturePageProps) {
  ...
  async function save<K extends keyof Pick<typeof state, "units" | "departments" | "teams" | "teamMembers" | "pointSchedules" | "employees">>(entity: K, value: typeof state[K][number]) {
    ...
    notify({ tone: "success", title: entity === "employees" ? "Colaborador salvo" : "Estrutura salva", message: entity === "employees" ? "Funcionário salvo no Supabase e perfil de acesso preparado em users_profiles." : "Hierarquia, escopo e gestão da equipe atualizados." });
  }
