...
export function StatusSistemaPage({ state, notify, setPage }: FeaturePageProps) {
  ...
  const productionItems = [
    ...
    { label: "Migration v4.6 preparada", ok: true, detail: "Arquivo idempotente incluído em supabase/migrations" },
    ...
    { label: "PWA/mobile", ok: true, detail: "Manifest, service worker e navegação mobile inclusos" },
  ];
